...
class Post():
    ...
    def positive(self):
        self.word = open('positive-words.txt', 'r')
        amount = self.word.read()
        fin = amount.split()
        return len(fin)
...
#We are opening the plain text file samplepost into a plain text format
sample_post_dict = json.loads(sample)
#We are creating a json formatted dictionary of the text file
p = Post(sample_post_dict)
#We are making an instance of the class Post using the sample_post_dict
