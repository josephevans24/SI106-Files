...
# This evaluates to the list "data" the entire data set is rooted in this list
# What about fb_data["data"][1]?
 # This evaluates to the second list that is nested in the entire dictionary. There are two data list within this and this directs you to the second
# What about fb_data["data"][0]["from"]?
#this evaluates to a dictionary
